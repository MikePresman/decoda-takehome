...
## Current Railway Prep

This repository now includes a minimal FastAPI service so Railway has a real web process to boot while the fuller application is being built.
